...
export enum ShopEventType {
  ...
  PAYMENT__CHOOSE_TYPE = "PAYMENT__CHOOSE_TYPE",
...
type ShopMachineEvents =
  ...
  | {
      type: ShopEventType.PAYMENT__CHOOSE_TYPE;
      value: "creditcard" | "paypal";
    }
  | {
    ...
    [ShopState.PAYMENT]: {
      ...
      states: {
        [ShopStatePayment.INIT]: {
          on: {
            [ShopEventType.PAYMENT__CHOOSE_TYPE]: {
